...
void testAllExtins() {
    std::cout << "Incepere teste extinse...\n";
    ...
    std::cout << "Test extins (partea 1) trecut cu succes!\n";
    ...
    std::cout << "Test extins (partea 2) trecut cu succes!\n";
    ...
    std::cout << "Test extins (partea 3) trecut cu succes!\n";
    ...
    std::cout << "Test extins (partea 4) trecut cu succes!\n";
}
