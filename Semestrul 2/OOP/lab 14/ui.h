...
public:
     ...
     */
    const void print_meds(AbstractRepo& storage, const string& header) const;
     ...
     */
    const int read_id_with_string(AbstractRepo& storage, const string& msg_out, const string& msg_err);
     ...
     */
    const void filterPret(AbstractRepo &storage, int pret, char op) const;
     ...
     */
    const void filterSubstActiva(AbstractRepo &storage, const string& subst) const;
     ...
     */
    const void genericSort(AbstractRepo &storage, function<int(const Medicament&, const Medicament&)> functie_comparare) const;
