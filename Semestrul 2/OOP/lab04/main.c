...
void run_app() {
    ...
    storage_cheltuieli = adauga_o_noua_cheltuiala(storage_cheltuieli, 0, 12, 230, internet);
    char* apa = "apa";
    storage_cheltuieli = adauga_o_noua_cheltuiala(storage_cheltuieli, 1, 7, 560, apa);
    char *curent = "curent";
    storage_cheltuieli = adauga_o_noua_cheltuiala(storage_cheltuieli, 2, 20, 120, curent);*/
