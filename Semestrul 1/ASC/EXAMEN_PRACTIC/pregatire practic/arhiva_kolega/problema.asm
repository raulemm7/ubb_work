...
; Să citesc un nume de fisier si un numar de la tastatura. În fisierul respectiv erau cuvinte separate de spatii și linii 
; și trebuia sa scrii în alt fișier doar acele cuvinte care au numărul de consoane egal cu numărul citit de la tastatură.
